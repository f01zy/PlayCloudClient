  ...
  return fetchUser ? (
    <div className={styles.profile}>
      ...
      <div className={styles.user}>
        <div className={styles.banner}>{fetchUser.banner && <Image src={`${SERVER_URL}/banner/${fetchUser._id}.jpg`} alt="avatar" width={100} height={100} className="w-full h-full" />}</div>
